...
def find_voids(ngrid, 
    ...
    #
    # Don't do this anymore because it complicates/duplicates the logic and API
    #  in _main_hole_finder.  Leaving it commented out here for now.
    #
    #cell_ID_dict, mesh_indices = mesh_galaxies_dict(w_coord, coord_min, dl)
    ...
    x_y_z_r_array, n_holes = _main_hole_finder(ngrid, 
                                               dl, 
                                               dr,
                                               coord_min,
                                               mask,
