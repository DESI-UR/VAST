...
out_directory = '/scratch/ierez/IGMCosmo/VoidFinder/outputs/delta_runs/before_merge/'

# Input file name
#data_filename = 'data.dat'  # File format: RA, dec, redshift, comoving distance, absolute magnitude
#data_filename = 'mini_data_reconstructed_removed.dat' 
data_filename = 'deltafields_RAadded90.fits'

#data_type='delta_fields'
#data_type='galaxies' or 'tomographic_maps'
...
# Need to also uncomment relevant inputs in function calls below
#dist_metric = 'redshift'
#-------------------------------------------------------------------------------

#-------------------------------------------------------------------------------
# Uncomment if you do NOT want to remove data with Mr > -20
# Need to also uncomment relevent input in function call below
mag_cut = False #for galaxies
flux_cut = None #for delta fields or tomographic maps

# Uncomment if you do NOT want to remove isolated data
# Need to also uncomment relevent input in function call below
#rm_isolated = False
#-------------------------------------------------------------------------------
