...
import sys
sys.path.insert(0, "/scratch/ierez/Voids/VoidFinder/python/")
################################################################################
#
#   IMPORT MODULES
#
...
in_directory = '/scratch/ierez/Voids/VoidFinder/data/DR16S82_deltas/reconstructed/'
out_directory = '/scratch/ierez/Voids/VoidFinder/data/DR16S82_deltas/reconstructed/'
# Input file name
