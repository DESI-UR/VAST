...
# Input file names
galaxies_filename = 'DESI_void_mock_0.fits'  # File format: RA, dec, redshift, comoving distance, absolute magnitude
mask_filename = 'void_0_mask.dat'            # File format: RA, dec
